...
#------- Program execution -------#
echo "========================================"
echo "CUDA GEMM v2.0.0 Performance Test"
echo "Date: $(date)"
echo "Node: $(hostname)"
echo "========================================"
...
nvcc -O3 -arch=sm_70 -use_fast_math -o gemm_cuda_v2.0.0 gemm_cuda_v2.0.0.cu
